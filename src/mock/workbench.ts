...
export const workbench: Workbench = {
  ...
  nodes: [
    ...
    { nodeId: "bs-nde", label: "Non-drive seat", group: "Bearing seats", provenance: "overridden", citation: "Pack §F-2", value: "<<check - pending>>", sketchX: 196, sketchY: 30 },
    ...
    // ── Coupling end ──
    { nodeId: "ce-key", label: "Keyway", group: "Coupling end", provenance: "llm", citation: "Pack §CS-1", value: "<<dim>>", sketchX: 256, sketchY: 18 },
